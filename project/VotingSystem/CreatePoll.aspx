<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatePoll.aspx.cs" Inherits="VotingSystem.CreatePoll" EnableEventValidation="false" %>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Poll</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <select runat="server" class="form-control" aria-label="Default select example" name="ddlPollVisibility" id="ddlPollVisibility">
                                            ...
                                            <option runat="server" value="Students Part-Time">Students Part-Time</option>
                                            <option runat="server" value="Students Full-Time">Students Full-Time</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
